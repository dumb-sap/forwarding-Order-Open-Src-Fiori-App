		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#forwardingorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"forwardingorder-display": {
								"semanticObject": "forwardingorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=forwardingorder",
									"url": sap.ui.require.toUrl("forwardingorder")
								}
							}
						}
					}
